...
% Alpha   - compactness of mode constraint 平衡权重
% omega_int - initial guess of mode center-frequency (Hz) 中心频率
% tau     - time-step of the dual ascent. set it to 0 in the presence of
%           high level of noise. 双重上升的时间步长。在存在的情况下将其设置为0 (梯度上升 最小化)
% tol     - tolerance of convergence criterion; typically around 1e-6 残差能量容忍度
%
%
%
% Output:
...
omega_d = zeros(N, 1);
omega_d(1) = omega_int/fs;  % ?归一化的角频率
